...
@keyframes show-message {
  ...
  <legend>Envianos tus comentarios</legend>
    ...
    <textarea name="comments"cols="50" rows="5" placeholder="Escribe tus comentarios" title="Tu comentario no debe exceder los  255 caracteress" data-pattern="^.{1,255}$" required></textarea>
  ...
  function validationsForm() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/heliogonzalesr@gmail.com", {
        method: "POST",
