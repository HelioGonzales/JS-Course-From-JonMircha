...
export default function userDeviceInfo(id) {
    ...
    /* Contenido exclusivo */
    if (isBrowser.chrome()) {
        $id.innerHTML += `<p><mark>Este contenido solo o se ve en Chrome</mark></p>`;
    }

    if (isBrowser.firefox()) {
        $id.innerHTML += `<p><mark>Este contenido solo o se ve en Firefox</mark></p>`;
    }
    ...
    if(isMobile.android()) {
        window.location.href = "https:deftones.com"
    }
}
